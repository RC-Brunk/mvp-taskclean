...
router.post('/', authMiddleware, checkRole(['manager']), jsonParser, taskController.createTask);
router.put('/:id', authMiddleware, checkRole(['manager']), jsonParser, taskController.updateTask);
